...
test(
  ...
  async ({ page }) => {
    ...
    // paddingX=-66 → width=831-132=699, paddingY=-140 → height=570-280=290
    await focusedScreenshot(
      page,
      previewContainer,
      path.join(IMG_DIR, "view-improvements.png"),
      { paddingX: -66, paddingY: -140, mouseOffset: { x: 30, y: 30 }, cursorUrl: CURSOR_SVG_HIGHLIGHT_URL, cursorSize: 60 },
    );
